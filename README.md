...
<p align="center">
  ...
  <i>Building thoughtful software — from AI health platforms to peer-to-peer marketplaces.</i>
</p>
...
### 🧠 About Me
- 🎓 **BS Software Engineering** graduate from **PUCIT, Lahore** (2022–2026)
- 💻 Software Development Intern at **Devbais**, working with **Angular** and **.NET MAUI**
- 🏥 Built an **AI-based Fitness Platform (FitBot)** as my Final Year Project
- 🛠️ Built **RentAll**, a peer-to-peer equipment rental platform (.NET + Angular + Stripe)
...
### 🏆 Highlights
- 💻 Software Development Intern at **Devbais** — Angular, .NET MAUI
- 📜 Web Development Internship @ **Cybros** — PostgreSQL, MongoDB, TypeORM, React, Node.js, Express
